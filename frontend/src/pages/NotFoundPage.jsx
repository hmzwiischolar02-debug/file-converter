...
export default function NotFoundPage({ navigate }) {
  return (
    <div className="max-w-md mx-auto px-4 py-36 text-center">
      ...
      <h1 className="font-extrabold text-slate-900 text-3xl mb-3">
        Page Not Found
      </h1>
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <button
          ...
          className="px-8 py-3 border-2 border-slate-200 text-slate-700 font-semibold rounded-xl hover:bg-slate-50 transition-colors"
        >
          Browse Tools
        </button>
      </div>
